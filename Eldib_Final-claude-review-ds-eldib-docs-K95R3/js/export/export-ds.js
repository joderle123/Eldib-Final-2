...
<!-- NEUE SEITE: Visueller Altersvergleich pro Bereich -->
<div class="page-break"></div>
<p class="heading2" style="margin-top:0;">6.2 Testergebnisse (Fortsetzung) - Visueller Altersvergleich</p>
...
<p style="font-size:10pt; color:#666; margin-bottom:18pt;">Die folgenden Balken zeigen den Vergleich zwischen dem biologischen Alter (blaue Referenzlinie) und dem sozio-emotionalen Entwicklungsalter in jedem der vier Bereiche. Ein kürzerer Balken im Entwicklungsalter deutet auf einen Förderbedarf in diesem Bereich hin.</p>

<!-- Biologisches Alter als Referenz -->
<div style="margin-bottom:18pt; padding:12pt; background:#E8F4FD; border-radius:6pt; border:2pt solid #5B9BD5;">
<div style="display:table; width:100%; margin-bottom:8pt;">
<span style="display:table-cell; font-weight:bold; font-size:12pt; color:#5B9BD5;">Biologisches Alter (Referenz)</span>
<span style="display:table-cell; text-align:right; font-size:11pt; font-weight:bold; color:#2F5496;">${biologicalAge ? biologicalAge.years + ' Jahre ' + biologicalAge.months + ' Monate' : '-'}</span>
</div>
<table style="width:100%; border-collapse:collapse;">
<tr>
<td style="width:120pt; padding:4pt 8pt 4pt 0; font-size:10pt; color:#5B9BD5; font-weight:bold;">Bio. Alter:</td>
<td style="padding:4pt;">
<div style="width:100%; height:20pt; background:#E7E6E6; border:1pt solid #5B9BD5; border-radius:3pt; overflow:hidden;">
<div style="width:${biologicalAge ? Math.min((biologicalAge.decimal / 18) * 100, 100) : 0}%; height:100%; background:#5B9BD5;"></div>
</div>
</td>
</tr>
</table>
<div style="display:table; width:100%; font-size:8pt; color:#666; margin-top:4pt;">
<span style="display:table-cell; text-align:left;">0 Jahre</span>
<span style="display:table-cell; text-align:center;">9 Jahre</span>
<span style="display:table-cell; text-align:right;">18 Jahre</span>
</div>
</div>
